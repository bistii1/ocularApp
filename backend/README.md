...
│  4. Video uploaded to backend serve5r                        │
...
videos in the p01 folder are the ground truth, validates if the pupil detection is working correctly 

testing validation of a video (prerecorded) in terminal: python validate.p path/to/video 





make it wire up with the matlab + python 